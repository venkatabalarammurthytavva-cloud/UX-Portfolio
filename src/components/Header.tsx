...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0D0D0E]/95 backdrop-blur-md border-b border-[#202022] transition-all">
      <div className="relative flex justify-between items-center h-20 px-6 sm:px-8 max-w-[1440px] mx-auto w-full">
        ...
        <nav className="hidden md:flex items-center gap-8 lg:gap-12 font-label-caps text-[13px] tracking-[0.18em] uppercase absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-auto">
          {/* WORK */}
          <button
            onClick={() => setActiveTab('work')}
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 z-10">
          ...
          <a
            ...
            aria-label="Email"
            title="Email"
            className="w-9 h-9 rounded-full bg-[#1A1C20] border border-white/20 flex items-center justify-center text-white/90 hover:text-white hover:bg-white/15 hover:border-white/40 hover:shadow-[0_0_12px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-105 active:scale-95 flex-shrink-0 focus:outline-none"
          >
